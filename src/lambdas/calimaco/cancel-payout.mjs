...
export const lambda_handler = async (event, context, callback) => {
    ...
    try {
        ...
        const operation = validateNumberParam(payload.amount, "amount");
        ...
        const { data } = await callCalimacoApi(`${CALIMACO_BASE_URL}/data/cancelPayout`, {
            "company": "ACP",
        ...
        if (data.result == "error") {
            console.error("API cancelPayout:", data);

...
export const lambda_handler = async (event, context, callback) => {
    ...
    try {
        ...
        const hash = isValidString(queryParams.hash, "hash");
        ...
        const { data } = await callCalimacoApi(`${CALIMACO_BASE_URL}/payment/depositInfo`, {
            "company": "ACP",
        ...
        if(data.result == "error"){
            console.error("API depositInfo:", data);
